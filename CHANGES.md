...
- Define high-priority images.
  ...
  Byproduct of [#4498](https://github.com/syslabcom/scrum/issues/4498)
  [thet]
...
- Lazy load images.
  ...
  [#4498](https://github.com/syslabcom/scrum/issues/4498)
  [thet]

- Proposed more precise cache key to avoid volume mixes.
  [#4471](https://github.com/syslabcom/scrum/issues/4471)
  [pilz]
...
- Avoid computing `listAuthorsAndEditors` twice
  [#3678](https://github.com/syslabcom/scrum/issues/3678)
- Set redirect-to-publication as default view for Issue and Volume
  [#3151](https://github.com/syslabcom/scrum/issues/3151)
...
- Fix the `sehepunkte-import` view
  [#4071](https://github.com/syslabcom/scrum/issues/4071)
  [ale-rt]
...
- Fix mangled issue PDF in bulk upload
  [#3152](https://github.com/syslabcom/scrum/issues/3152)
  [reinhardt]

## 1.0.5 (2025-03-28)

- Fix errors caused by missing person references
  [#3373](https://github.com/syslabcom/scrum/issues/3373)
  [reinhardt]

## 1.0.4 (2025-02-10)

- Performance improvements
  [#3067](https://github.com/syslabcom/scrum/issues/3067)
  [ale-rt]

## 1.0.3 (2024-07-30)

- Fixed error when editing keywords
  [#2408](https://github.com/syslabcom/scrum/issues/2408)
  [reinhardt]
...
- Support changing PDF watermark image on publication.
  [#2385](https://github.com/syslabcom/scrum/issues/2385)
  [reinhardt]
